...
const createFollowController = require("../controllers/follow/createFollowController");
const deleteFollowController = require("../controllers/follow/deleteFollowController");
const getFollowListController = require("../controllers/follow/getFollowListController");
...
router.post(
  ...
  deleteFollowController.handleDeleteFollow
);
...
router.get(
  `/followings/:user_id`,
  verifyJwtToken.verifyToken,
  getFollowListController.handleFollowingList
);
...
router.get(
  `/followers/:user_id`,
  verifyJwtToken.verifyToken,
  getFollowListController.handleFollowerList
);
...
router.post(
  `/:user_id`,
  verifyJwtToken.verifyToken,
  createFollowController.handleCreateFollow
);
